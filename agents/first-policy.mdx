...
- **`coverageAmount`** — string of USDC base units. **Minimum: `"100000000"` (= $100, enforced on-chain).** $100 = `"100000000"`, $1,000 = `"1000000000"`. Always pass as a string to preserve precision.
